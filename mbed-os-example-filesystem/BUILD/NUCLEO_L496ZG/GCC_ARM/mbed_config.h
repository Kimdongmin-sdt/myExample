...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "251327412287"                                                                                   // set by application
#define MBED_CONF_APP_WIFI_SECURITY                                           WPA2                                                                                             // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "sigdeltec"                                                                                      // set by application
